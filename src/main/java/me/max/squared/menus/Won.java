 ...
 */
public class Won extends MouseAdapter {
    ...
    public Won(Handler handler, HUD hud, Spawn spawner, EffectHandler effectHandler) {
    ...
    public void mouseClicked(MouseEvent e) {
        if (Game.gameState.toString().startsWith("WonLevel")) {
            if (e.getButton() == 1) {
                int mx = e.getX();
                int my = e.getY();
        ...
        } else if (!(Game.gameState == Game.STATE.WonLevel1) && !(Game.gameState == Game.STATE.WonLevel2) && !(Game.gameState == Game.STATE.WonLevel3) && !(Game.gameState == Game.STATE.WonLevel4) && !(Game.gameState == Game.STATE.WonLevel5) && !(Game.gameState == Game.STATE.WonLevel6) && !(Game.gameState == Game.STATE.WonLevel7) && !(Game.gameState == Game.STATE.WonLevel8) && !(Game.gameState == Game.STATE.WonLevel9) && !(Game.gameState == Game.STATE.Level1) && !(Game.gameState == Game.STATE.Level2) && !(Game.gameState == Game.STATE.Level3) && !(Game.gameState == Game.STATE.Level4) && !(Game.gameState == Game.STATE.Level5) && !(Game.gameState == Game.STATE.Level6) && !(Game.gameState == Game.STATE.Level7) && !(Game.gameState == Game.STATE.Level8) && !(Game.gameState == Game.STATE.Level9) && !(Game.gameState == Game.STATE.Died) && !(Game.gameState == Game.STATE.LevelChooser) && !(Game.gameState == Game.STATE.Menu) && !(Game.gameState == Game.STATE.HardcoreMode) && !(Game.gameState == Game.STATE.InGameShop) && !(Game.gameState == Game.STATE.MenuShop) && !(Game.gameState == Game.STATE.Help) && !(Game.gameState == Game.STATE.Credits) && !(Game.gameState == Game.STATE.PauseScreen)) {
            int mx = e.getX();
            int my = e.getY();
            if ((mouseOver(mx, my, Game.WIDTH / 2 - 90, 152, 200, 60))) {
                handler.object.clear();
